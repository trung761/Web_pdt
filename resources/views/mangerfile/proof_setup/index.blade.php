                        ...
                        <div class="row">
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="id_place_user" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Năm học:</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Quy trình</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="" class="col-sm-4 col-form-label" style="padding-bottom: 0px">ID Hố sơ:</label>
                                    <div class="col-sm-8">
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Loại kiểm định:</label>
                                    <div class="col-sm-8">
                                        <select class="form-control"  id="poorf_type" style="width: 100%;">
                                            {{-- <option value="0">Chọn Năm học</option>
                                            <option value="1">Đăng ký tài khoản</option>
                                            <option value="2">Lưu nguyện vọng</option> --}}
                                            <option value="3">Kiểm định cơ sở đào tạo</option>
                                            <option value="3">Kiểm định Chương trình đào tạo - HTTT</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="id_place_user" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Hộp minh chứng:</label>
                                    <div class="col-sm-8">
                                        <select class="form-control"  id="poorf_box" style="width: 100%;">
                                            {{-- <option value="0">Chọn Năm học</option>
                                            <option value="1">Đăng ký tài khoản</option>
                                            <option value="2">Lưu nguyện vọng</option> --}}
                                            <option value="3">H14</option>
                                            <option value="3">H15</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="id_place_user" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Tiêu chuẩn:</label>
                                    <div class="col-sm-8">
                                        <select class="form-control"  id="poorf_box_1" style="width: 100%;">
                                            {{-- <option value="0">Chọn Năm học</option>
                                            <option value="1">Đăng ký tài khoản</option>
                                            <option value="2">Lưu nguyện vọng</option> --}}
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="id_place_user" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Tiêu chí:</label>
                                    <div class="col-sm-8">
                                        <select class="form-control"  id="poorf_box_2" style="width: 100%;">
                                            {{-- <option value="0">Chọn Năm học</option>
                                            <option value="1">Đăng ký tài khoản</option>
                                            <option value="2">Lưu nguyện vọng</option> --}}
                            ...
                            <div class="col-md-12 col-12">
                                <div class="form-group row" style="margin-bottom: 3px">
                                    <label for="id_user_check" class="col-sm-4 col-form-label" style="padding-bottom: 0px">Thứ tự</label>
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control" id='' style="height:28px;">
                                    </div>
                                </div>
...
<script src="/managerfile/js/proof_setup/control.js"></script>
