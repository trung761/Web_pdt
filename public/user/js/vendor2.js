...
$(function() {
                ...
                if (data == "1") {
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response == 'BÃ¬nh luáº­n Ä‘ang Ä‘Æ°á»£c phÃª duyá»‡t' || response == 'Comment is being approved') {
        ...
        if (username == "") {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response == 'Email khÃ´ng há»£p lá»‡' ||
                        response == 'This email is not valid' ||
                        response == 'Há» tÃªn khÃ´ng há»£p lá»‡' ||
                        response == 'This name is not valid' ||
                        response == 'Gá»­i email khÃ´ng thÃ nh cÃ´ng' ||
    ...
    $("#signup_button").click(function() {
        ...
        if (email === "") {
            ...
            $('<div class="alert alert-danger alert-dismissable">' + '                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">Ã—</button>' + '                            <div class="message"> Máº­t kháº©u khÃ´ng Ä‘Ãºng </div>' + '                            </div>').insertBefore("#signup_form")
        } else {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == '1') {
                        $('.alert-dismissable').hide();
                        $(' <div class="alert alert-success">ÄÄƒng kÃ½ thÃ nh cÃ´ng</div>').insertBefore("#signup_form");
                        ...
                        $('.alert-danger').hide();
                        $(' <div class="alert alert-danger">Email hoáº·c tÃªn tÃ i khoáº£n Ä‘Ã£ Ä‘Æ°á»£c sá»­ dá»¥ng</div>').insertBefore("#signup_form")
                    }
                }
            })
        }
    ...
    $('#view_more_comment').click(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                m
                if (response == '0') {
                    $('#view_more_comment').text('KhÃ´ng cÃ²n bÃ¬nh luáº­n khÃ¡c')
                } else if (response) {
    ...
    $('.header-comments').on('click', '#logout_user', function() {
        $.get('/dang-xuat', function(data) {
            if (data == '1') {
                $('.comments .links').html(' <button data-toggle="modal" data-target="#registerModal">ÄÄƒng kÃ½</button>\n' + '                                    <span>&nbsp;/&nbsp;</span>\n' + '                                    <button data-toggle="modal" data-target="#loginModal">ÄÄƒng nháº­p</button>')
            }
        })
    })
    $('#survey_button').click(function() {
        ...
        if (yes.length != 0 || no.length != 0) {
            ...
            $('<div class="alert alert-danger">Báº¡n chÆ°a chá»n cÃ¢u tráº£ lá»i</div>').insertBefore('#survey_note')
        }
    });
